<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cdie1.aspx.cs" Inherits="Cdie1" %>
...
<head id="Head1" runat="server">
    <title>Unuseable Cutting Die Stock</title>
...
<table style="width: 100%; height: 131px;" >
    <tr>
        <td class="style6">
             <img src="Images/Header.jpg" width="121%" height="131"  alt="header"/>
        </td>
    </tr>
</table>
<body>
...
mso-bidi-font-family:Wingdings"><span style="mso-list:Ignore; color: #FFFFFF;">§<span style="font:7.0pt &quot;Times New Roman&quot;"> </span></td>
  ...
  <table style="width: 100%; height: 25px;">
                                        <tr>
                                         <td style="border-style: 1; border-color: #003399; background-color: #FFFFFF"  
                                                ...
                                                <strong style="font-size: large;color:Black;  font-family: 'Century Gothic'">Unuseable Cutting Die Stock</strong></td>
                                            <td class="style143"></td>
                                            <td align="right" class="style151">
                                                        <asp:ImageButton ID="ImageButton4" runat="server" ImageUrl="Images/senddout.jpg"  OnClick="ImageButton4_Click"
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.view1', function () {
            ...
            $.ajax({
                type: "POST",
                url: "Cdie1.aspx/UpdateCustomer1",
                data: '{empid: ' + id + '}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
                    ...
                    if (row == null) {
                      ...
                      $("[id$=gvDetails] tbody tr").not($("[id$=gvDetails] tbody tr:first-child")).remove();
                                                            $.each(customers, function () {
                                                                ...
                                                                $("td", row).eq(3).html($(this).find("dieno").text());
                                                                $("td", row).eq(4).html($(this).find("pid").text());
                                                                $("td", row).eq(5).html($(this).find("description").text());
                                                                $("td", row).eq(6).html($(this).find("templateno").text());

                                                                $("td", row).eq(7).html($(this).find("supplier").text());
                                                                $("td", row).eq(8).html($(this).find("waybillno").text());
                                                                $("td", row).eq(9).html($(this).find("comment").text());
                                                                $("td", row).eq(10).html($(this).find("deliverydate").text());
                                                                $("td", row).eq(11).html($(this).find("lmacross").text());
                                                                $("td", row).eq(12).html($(this).find("lmaround").text());
                                       ...
                                       <asp:ListItem Text="25" Value="25" />
                                        ...
                                        <asp:ListItem Text="100" Value="100" />
                                         ...
                                         BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" 
                                                ...
                                                Width="100%" Style="margin-bottom: 0px" CssClass="grid" BorderWidth="1px" CellPadding="3" Font-Bold="false" OnRowDataBound="gvDetails_RowDataBound"  OnRowDataBound1="OnRowCreated" >
                                        <Columns>
                                        ...
                                        <asp:TemplateField>
                                          ...
                                          <asp:BoundField DataField="id" HeaderText="Stockid" />  
                                            ...
                                            <asp:BoundField DataField="templateno" HeaderText="Template .No" />
                                          
                                            <asp:BoundField DataField="supplier" HeaderText="Supplier" />
                                            <asp:BoundField DataField="waybillno" HeaderText="Waybill.No" />

                                              <asp:BoundField DataField="comment" HeaderText="Comment" />
                                            <asp:BoundField DataField="deliverydate" HeaderText="Waybill No" />
                                            <asp:BoundField DataField="lmacross" HeaderText="Lmacross" />
                                              <asp:BoundField DataField="lmaround" HeaderText="Lmaround" />
 ...
 <asp:TemplateField>
    ...
    <asp:Button CssClass="view" Text="Useable" ID="Button" runat="server"  ForeColor="white"  Style="border-radius: 6px"  BackColor="orange" />
    ...
    <asp:Button CssClass="view1" Text="Obosolete" ID="Button2" runat="server"  ForeColor="white"  Style="border-radius: 6px"  BackColor="orange" />
                                                                </ItemTemplate>
