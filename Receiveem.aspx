<%@ Page Language="C#" AutoEventWireup="true"   Debug="true" CodeFile="Receiveem.aspx.cs" Inherits="Receiveem" %>
                            ...
                            <tr>
                                <td class="style5" align="center" style="background-color: #FFFFFF">
                                    ...
                                    <asp:GridView ID="gvDetails" runat="server" AutoGenerateColumns="False"
                                        ...
                                        Font-Names="Century Gothic" Font-Size="X-Small" DataKeyNames="orderid"
                                        ...
                                        <Columns>
                                          ...
                                          <asp:BoundField DataField="purchaseorderno" HeaderText=" PO Number"  itemstyle-horizontalalign="Center"/>
                                           ...
                                           <asp:BoundField DataField="embid" HeaderText="Film /Model No/Ink Code" itemstyle-horizontalalign="Center"/>
