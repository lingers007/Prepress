<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cdie3.aspx.cs" Inherits="Cdie3" %>
...
<table style="width: 100%; height: 131px;" >
    <tr>
        <td class="style6">
             <img src="Images/Header.jpg" width="103%" height="131"  alt="header"/>
        </td>
    </tr>
</table>
<body>
                                           ...
                                           <table style="width: 100%; height: 25px;">
                                                <tr>
                                                    <td style="border-style: 1; border-color: #003399; background-color: #FFFFFF"
                                                        ...
                                                        <strong style="font-size: large; color:Black; font-family: 'Century Gothic'">Sent Cutting Die</strong></td>
