<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cylin.aspx.cs" Inherits="Cylin" %>
...
<head id="Head1" runat="server">
    <title>Unuseable Cylinder</title>
...
<table style="width: 100%; height: 131px;" >
    <tr>
        <td class="style6">
             <img src="Images/Header.jpg" width="126%" height="131"  alt="header"/>
        </td>
    </tr>
</table>
<body>
...
mso-bidi-font-family:Wingdings"><span style="mso-list:Ignore; color: #FFFFFF;">§<span style="font:7.0pt &quot;Times New Roman&quot;"> </span></td>
                                           ...
                                           <table style="width: 100%; height: 25px;">
                                                <tr>
                                                    <td style="border-style: 1; border-color: #003399; background-color: #FFFFFF"
                                                        ...
                                                        <strong style="font-size: large; font-family: 'Century Gothic'">Unuseable Cylinder</strong></td>
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.view', function () {
            ...
            $.ajax({
                type: "POST",
                url: "Cylin.aspx/UpdateCustomer1",
                data: '{empid: ' + id + '}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
                ...
                error: function (response) {
                    alert(response.responseText);
                                       ...
                                       <asp:ListItem Text="25" Value="25" />
                                        ...
                                        <asp:ListItem Text="100" Value="100" />
                                            ...
                                            <asp:GridView ID="gvDetails" runat="server" AutoGenerateColumns="False"
                                                ...
                                                Font-Names="Arial" Font-Size="12px" DataKeyNames="id" Font-Bold="false" 
					          ...
					          <asp:BoundField DataField="circumference" HeaderText="Circ." />
                                                    ...
                                                    <asp:TemplateField>
                                                        <ItemTemplate>                                                         
                                                            <asp:Button CssClass="view" Text="Useable" ID="Button1" runat="server" Font-Size="Smaller" width="60px"  ForeColor="white" Style="border-radius: 6px"  BackColor="orange" />
                                                        </ItemTemplate>
                                                          </asp:TemplateField>
                                                        <asp:TemplateField>
                                                         <ItemTemplate>                                                         
                                                            <asp:Button CssClass="view1" Text="Obosolete" ID="Button2" runat="server" Font-Size="Smaller" width="60px" ForeColor="white" Style="border-radius: 6px"  BackColor="orange" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
