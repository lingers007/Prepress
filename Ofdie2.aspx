<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ofdie2.aspx.cs" Inherits="Ofdie2" %>
...
mso-bidi-font-family:Wingdings"><span style="mso-list:Ignore; color: #FFFFFF;">§<span style="font:7.0pt &quot;Times New Roman&quot;"> </span></td>
                                           ...
                                           <table style="width: 100%; height: 25px;">
                                                <tr>
                                                    <td style="border-style: 1; border-color: #003399; background-color: #FFFFFF"
                                                        ...
                                                        <strong style="font-size: large; color:Black; font-family: 'Century Gothic'">Obosolete Offline Cutting Die</strong></td>
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.view', function () {
            ...
            $.ajax({
                type: "POST",
                url: "Ofdie2.aspx/UpdateCustomer",
                data: '{empid: ' + id + '}',
