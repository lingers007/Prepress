<%@ Page Language="C#" AutoEventWireup="true"     debug="true"   CodeFile="Received1.aspx.cs" Inherits="Received1" %>
...
<table style="width: 100%;">
    <tr>
        <td  class="style26">
            &nbsp;</td>
        <td class="style15">
           <table align="center" border="2px" bordercolor="grey" 
 ...
 <br /> <br />
                 ...
                 <table style="width:100%;" border="1">
                     ...
                     <tr>
                         <td class="style25">
                             <strong>ACCEPT THIS ORDER</strong></td>
                         <td>
                             &nbsp;</td>
                         <td align="right">
                     ...
                     <tr>
                         ...
                         <td align="center">
                             <asp:Button ID="Button1" runat="server" Font-Bold="True" 
                                 onclick="Button1_Click" Text="Accept Item" Width="137px" />
                         </td>
                     </tr>
                 </table>
                             <br />
