<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ofdie.aspx.cs" Inherits="Ofdie" %>
...
<head id="Head1" runat="server">
    <title>Useable Offline Cutting Die Stock</title>
                                           ...
                                           <table style="width: 100%; height: 25px;">
                                                <tr>
                                                    <td style="border-style: 1; border-color: #003399; background-color: #FFFFFF"
                                                        ...
                                                        <strong style="font-size: large; color:Black; font-family: 'Century Gothic'">Useable Offline Cutting Die</strong></td>
