<%@ Page Language="C#" AutoEventWireup="true"  debug="true" CodeFile="Receive1.aspx.cs" Inherits="Receive1" %>
                 ...
                 <table style="width: 50%; height: 47px;" align="right">
                    <tr>
                        ...
                        <table id="customGrid" class="display" 
                            style="width:100%; height: 100%; color: #000080; background-color: #000099;" 
                            align="center">
                            <tr>
                            ...
                            <tr>
                                <td class="style5" align="center" style="background-color: #FFFFFF">
                                    ...
                                    <asp:GridView ID="gvDetails" runat="server" AutoGenerateColumns="False"
                                        ...
                                        Font-Names="Arial" Font-Size="13px" DataKeyNames="orderid"
                                        ...
                                        <Columns>
                                          ...
                                          <asp:BoundField DataField="purchaseorderno" HeaderText=" PO Number"  itemstyle-horizontalalign="Center"/>
                                           ...
                                           <asp:BoundField DataField="posino" HeaderText="Film /Model No/Ink Code" itemstyle-horizontalalign="Center"/>
