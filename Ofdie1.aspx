<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ofdie1.aspx.cs" Inherits="Ofdie1" %>
...
<head id="Head1" runat="server">
    <title>Unuseable Offline Cutting Die Stock</title>
...
mso-bidi-font-family:Wingdings"><span style="mso-list:Ignore; color: #FFFFFF;">§<span style="font:7.0pt &quot;Times New Roman&quot;"> </span></td>
                                           ...
                                           <table style="width: 100%; height: 25px;">
                                                <tr>
                                                    <td style="border-style: 1; border-color: #003399; background-color: #FFFFFF"
                                                        ...
                                                        <strong style="font-size: large; color:Black; font-family: 'Century Gothic'">Unuseable Offline Cutting Die</strong></td>
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.view', function () {
            ...
            $.ajax({
                type: "POST",
                url: "Ofdie1.aspx/UpdateCustomer",
                data: '{empid: ' + id + '}',
         ...
         $(document).on('click', '.view1', function () {
            ...
            $.ajax({
                type: "POST",
                url: "Ofdie1.aspx/UpdateCustomer1",
                data: '{empid: ' + id + '}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
        ...
        function GetCustomers(pageIndex) {
            $.ajax({
                ...
                $.each(customers, function () {
                    ...
                    $("td", row).eq(3).html($(this).find("gietzdieref").text());
                    $("td", row).eq(4).html($(this).find("pid").text());
                    $("td", row).eq(5).html($(this).find("description").text());
                    $("td", row).eq(6).html($(this).find("cadgietzdie").text());
                    $("td", row).eq(7).html($(this).find("packingperpallet").text());
                    $("td", row).eq(8).html($(this).find("hotfoilcoverage").text());
                    $("td", row).eq(9).html($(this).find("blockspersheet").text());
                    $("td", row).eq(10).html($(this).find("supplier").text());
                    $("td", row).eq(11).html($(this).find("waybillno").text());
                    $("td", row).eq(12).html($(this).find("foilarea").text());
                    ...
                    alert(response.responseText);
                                    ...
                                    <asp:DropDownList runat="server" ID="ddlPageSize">
                                       ...
                                       <asp:BoundField DataField="id" HeaderText="stockid" />     
                                            ...
                                            <asp:BoundField DataField="gietzdieref" HeaderText="Die .No" />
                                            <asp:BoundField DataField="pid" HeaderText="Prod .Code" />
                                            <asp:BoundField DataField="description" HeaderText="Description" />
                                             <asp:BoundField DataField="cadgietzdie" HeaderText="Die Ref,No" />
                                            <asp:BoundField DataField="packingperpallet" HeaderText="Pack .Pall" />
                                            <asp:BoundField DataField="hotfoilcoverage" HeaderText="Hot Foil .Cov" />
                                            <asp:BoundField DataField="blockspersheet" HeaderText="Blk Per Sheet" />

                                              <asp:BoundField DataField="supplier" HeaderText="Supplier" />
                                            <asp:BoundField DataField="waybillno" HeaderText="Waybill No" />
                                             <asp:BoundField DataField="foilarea" HeaderText="Foil Area" />  
                                                          ...
                                                          <asp:TemplateField>
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Button CssClass="view" Text="Unuseable" ID="Button2" runat="server"  ForeColor="white"  Style="border-radius: 6px"  BackColor="orange" />
                                                                </ItemTemplate>
