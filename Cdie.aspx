<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cdie.aspx.cs" Inherits="Cdie" %>
...
<head id="Head1" runat="server">
    <title>Useable Cutting Die Stock</title>
...
<table style="width: 100%; height: 131px;" >
    <tr>
        <td class="style6">
             <img src="Images/Header.jpg" width="125%" height="131"  alt="header"/>
        </td>
    </tr>
</table>
<body>
                                           ...
                                           <table style="width: 100%; height: 25px;">
                                                <tr>
                                                    <td style="border-style: 1; border-color: #003399; background-color: #FFFFFF"
                                                        ...
                                                        <strong style="font-size: large; color:Black; font-family: 'Century Gothic'">Useable Cutting Die</strong></td>
                                              ...
                                              <asp:BoundField DataField="lmaround" HeaderText="Lmaround" />
                                                             ...
                                                             <asp:TemplateField>
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Button CssClass="view" Text="Unuseable" ID="Button" runat="server"  ForeColor="white"  Style="border-radius: 6px"  BackColor="orange" />
                                                                </ItemTemplate>
