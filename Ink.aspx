<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ink.aspx.cs" Inherits="Ink" %>
...
<title>Manage Ink</title>
    ...
    <script type="text/javascript">
        ...
        $.ajax({
            type: "POST",
            url: "Ink.aspx/GetCustomersDetails",
            data: '{empid: ' + id + '}',
            ...
            success: function (response) {
                ...
                var xml = $(xmlDoc);
                var job_ink = xml.find("job_ink");
                var id = $(job_ink[0]).find("id").text();
                var inkcode = $(job_ink[0]).find("inkcode").text();
                var description = $(job_ink[0]).find("description").text();
                var gsm = $(job_ink[0]).find("gsm").text();
                var price = $(job_ink[0]).find("price").text();

                $('[id*=TextBox27]').val(inkcode);
                $('[id*=TextBox28]').val(description);
                $('[id*=TextBox29]').val(gsm);
    ...
    $(document).on('click', '.view1', function () {
        ...
        $.ajax({
            type: "POST",
            url: "Ink.aspx/GetCustomersDetails1",
            data: '{empid: ' + id + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (response) {
                ...
                $('[id*=TextBox1]').val(inkcode);
                $('[id*=TextBox2]').val(description);
                $('[id*=TextBox3]').val(gsm);
                $('[id*=TextBox4]').val(price);
    ...
    function GetCustomers(pageIndex) {
        $.ajax({
            ...
            success: function (response) {
                ...
                var xmlDoc = $.parseXML(response.d);
                var xml = $(xmlDoc);
                var customers = xml.find("job_ink");
                if (row == null) {
                ...
                $.each(customers, function () {
                    ...
                    $("td", row).eq(1).html($(this).find("inkcode").text());
                    $("td", row).eq(2).html($(this).find("description").text());
                    $("td", row).eq(3).html($(this).find("gsm").text());
                    $("td", row).eq(4).html($(this).find("pid").text());
                    $("td", row).eq(5).html($(this).find("price").text());
                                ...
                                <td class="style5" align="left" style="background-color: #FFFFFF">
                                    ...
                                    <asp:GridView ID="gvDetails" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="inkcode" HeaderText="inkcode" />
                                            <asp:BoundField DataField="description" HeaderText="Colour" />
                    ...
                    <td>
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Always">
                            <ContentTemplate>
                                ...
                                OnClick="Tab6_Click" Text="Ink" Width="151px"  UseSubmitBehavior="false"     Font-Bold="True"     Font-Names="Arial Narrow"     font-size="x-small" />
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <table border="1" class="roundedCorners" align="center"
                                                    ...
                                                    style="width:100%; font-size: x-small; font-family: 'Century Gothic'; font-weight: bold;">
                                                    <tr>
                    ...
                    <td>
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Always">
                            <ContentTemplate>
                                ...
                                OnClick="Tab2_Click" Text="  Ink" Width="151px"  UseSubmitBehavior="false"     Font-Bold="True"     Font-Names="Century Gothic"     font-size="x-small" />
