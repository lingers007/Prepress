<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cylin1.aspx.cs" Inherits="Cylin1" %>
...
<head id="Head1" runat="server">
    <title>Oboselete Cylinder</title>
...
<table style="width: 100%; height: 131px;" >
    <tr>
        <td class="style6">
             <img src="Images/Header.jpg" width="123%" height="131"  alt="header"/>
        </td>
    </tr>
</table>
<body>
...
mso-bidi-font-family:Wingdings"><span style="mso-list:Ignore; color: #FFFFFF;">§<span style="font:7.0pt &quot;Times New Roman&quot;"> </span></td>
                                           ...
                                           <table style="width: 100%; height: 25px;">
                                                <tr>
                                                    <td style="border-style: 1; border-color: #003399; background-color: #FFFFFF"
                                                        ...
                                                        <strong style="font-size: large; color:Black; font-family: 'Century Gothic'">Obosolete Cylinder</strong></td>
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.view', function () {
            ...
            $.ajax({
                type: "POST",
                url: "Cylin1.aspx/UpdateCustomer",
                data: '{empid: ' + id + '}',
					          ...
					          <asp:BoundField DataField="circumference" HeaderText="Circ." />
                                                    ...
                                                    <asp:TemplateField>
                                                        <ItemTemplate>                                                         
                                                            ...
                                                            <asp:Button CssClass="view" Text="Useable" ID="Button1" runat="server" Font-Size="Smaller" ForeColor="white" Style="border-radius: 6px"  BackColor="orange" />
                                                        </ItemTemplate>
                                                          </asp:TemplateField>
