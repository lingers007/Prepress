<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Receivecd.aspx.cs" Inherits="Receivecd" %>
                            ...
                            <tr>
                                <td class="style5" align="center" style="background-color: #FFFFFF">
                                    ...
                                    <asp:GridView ID="gvDetails" runat="server" AutoGenerateColumns="False"
                                        ...
                                        Font-Names="Arial Narrow" Font-Size="14px" DataKeyNames="orderid"
                                        ...
                                        <Columns>
                                          ...
                                          <asp:BoundField DataField="purchaseorderno" HeaderText=" PO Number"  itemstyle-horizontalalign="Center"/>
                                           ...
                                           <asp:BoundField DataField="dieno" HeaderText="Film/Model No/Ink Code" itemstyle-horizontalalign="Center"/>
