<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Conf3.aspx.cs" Inherits="Conf3" %>
                        ...
                        <table id="customGrid" class="display" style="width: 100%; height: 164px; color: #000080; background-color: #000099;">
                            ...
                            <tr>
                                <td class="style5" align="center" style="background-color: #FFFFFF">
                                    <br />
                                    <asp:HyperLink ID="HyperLink9" runat="server" NavigateUrl="UseableCyl.aspx">Return to Tool Stock</asp:HyperLink>       <br/> <br/>0r <br/><br/>  <asp:HyperLink ID="HyperLink90" runat="server" NavigateUrl="StockList.aspx">Go to Stock Packing List</asp:HyperLink> 
                                    <br />
                                    <br />
                                    <br />
                                    <br />
                                    ...
                                    <br />
                                    <br />
                                    You Have Succesfully Sent Out &nbsp; The Item             <br />
                                   <br />
                                    <br />
                                    <br />
                                    <br />
