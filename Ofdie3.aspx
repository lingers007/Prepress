<%@ Page Language="C#" AutoEventWireup="true"     Debug="true" CodeFile="Ofdie2.aspx.cs" Inherits="Ofdie2" %>
...
<head id="Head1" runat="server">
    <titleSent Offline Cutting Die Stock</title>
...
mso-bidi-font-family:Wingdings"><span style="mso-list:Ignore; color: #FFFFFF;">§<span style="font:7.0pt &quot;Times New Roman&quot;"> </span></td>
                                           ...
                                           <table style="width: 100%; height: 25px;">
                                                <tr>
                                                    <td style="border-style: 1; border-color: #003399; background-color: #FFFFFF"
                                                        ...
                                                        <strong style="font-size: large; color:Black; font-family: 'Century Gothic'">Sent Offline Cutting Die</strong></td>
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.view', function () {
            ...
            $.ajax({
                type: "POST",
                url: "Ofdie3.aspx/UpdateCustomer",
                data: '{empid: ' + id + '}',
                                       ...
                                       <asp:ListItem Text="25" Value="25" />
                                        ...
                                        <asp:ListItem Text="100" Value="100" />
                                         ...
                                         BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" 
                                                ...
                                                Width="100%" Style="margin-bottom: 0px" CssClass="grid" BorderWidth="1px" CellPadding="3" Font-Bold="false"    OnRowDataBound="OnRowCreated" >
                                        <Columns>
