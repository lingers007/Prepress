<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Issue1.aspx.cs" Inherits="Issue1" %>
    ...
    <tr>
        <td class="style15">
           ...
           <table class="display" align="center"  bordercolor="black" style="width: 1050px">
                ...
                <tr>
                    <td align="center" class="style20" style="font-size: large; color:black; font-family: Cambria; font-weight: bold;">
                 ...
                 <table style="width: 50%; height: 47px;" align="right">
                    <tr>
                        ...
                        <table id="customGrid" class="display"  bordercolor="black"  style="width: 100%; height: 164px; color: #000080; background-color: #000099;">
                            <tr>
                                <td style="border-style: 1; border-color: black; background-color: #FFFFFF"  class="style140" align="center">
                                    


                                    <table style="width: 100%; height: 25px; margin-left: 0px;">
                                        <tr>
                                         <td style=" border-color: #003399; background-color: #FFFFFF"  
                                                ...
                                                <strong>PRODUCTION SHEET</strong></td>
                                            <td>&nbsp;</td>
                                            <td align="right">
                                                &nbsp;</td>
                                        </tr>
