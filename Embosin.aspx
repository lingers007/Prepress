<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Embosin.aspx.cs" Inherits="Embosin" %>
...
<head id="Head1" runat="server">
    ...
    <title>Useable Embossing Stock</title>
...
<table style="width: 100%; height: 10px;">
    <tr>
        <td class="style6">
          <img src="Images/Header.jpg" width="116%" height="112"  alt="header"/>
        </td>
    </tr>
</table>
<body>
                                   ...
                                   <table style="width: 100%; height: 25px;">
                                        <tr>
                                         <td style="border-style: 1; border-color: #003399; background-color: #FFFFFF"  
                                                ...
                                                <strong style="font-size: large; font-family: 'Century Gothic'">Useable Embossing Stock</strong></td>
                            ...
                            <tr>
                                ...
                                <td class="style5" align="left" style="background-color: #FFFFFF">
                                      ...
                                      <script type="text/javascript" src=" https://code.jquery.com/jquery-3.5.1.js"></script>
                                            ...
                                            <script type="text/javascript">
                                                ...
                                                $(document).on('click', '.view', function () {
                                                    ...
                                                    $.ajax({
                                                        type: "POST",
                                                        url: "Embosin.aspx/UpdateCustomer",
                                                        data: '{empid: ' + id + '}',
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        success: function (response) {
                                                            ...
                                                            $.each(customers, function () {
                                                                ...
                                                                $("td", row).eq(3).html($(this).find("embid").text());
                                                                $("td", row).eq(4).html($(this).find("pid").text());
                                                                $("td", row).eq(5).html($(this).find("description").text());
                                                                $("td", row).eq(6).html($(this).find("mandrel").text());

                                                                $("td", row).eq(7).html($(this).find("type").text());
                                                                $("td", row).eq(8).html($(this).find("circmale").text());
                                                                $("td", row).eq(9).html($(this).find("circfemale").text());
                                                                $("td", row).eq(10).html($(this).find("diameter").text());
                                    ...
                                    <asp:GridView ID="gvDetails" runat="server" AutoGenerateColumns="False"
                                        ...
                                        Width="100%" Style="margin-bottom: 0px" CssClass="grid" BorderWidth="1px" CellPadding="1" OnRowDataBound="gvDetails_RowDataBound"  OnRowDataBound1="OnRowCreated" >
                                        <Columns>
                                       ...
                                       <asp:BoundField DataField="id" HeaderText="Stockid" />  
                                             <asp:BoundField DataField="no"  ItemStyle-Width="100" HeaderText="Base No" />   
                                            <asp:BoundField DataField="embid" ItemStyle-Width="100" HeaderText="die No" />
                                            <asp:BoundField DataField="pid" HeaderText="Prod.Code" />
                                            <asp:BoundField DataField="description" HeaderText="Description" />
                                            <asp:BoundField DataField="mandrel" HeaderText="Mandrel" />
                                          
                                            <asp:BoundField DataField="type" HeaderText="Type" />
                                            <asp:BoundField DataField="circmale" HeaderText="Waybill.No" />

                                              <asp:BoundField DataField="circfemale" HeaderText="Comment" />
                                            <asp:BoundField DataField="diameter" HeaderText="Waybill No" />
                                            <asp:BoundField DataField="waybillno" HeaderText="Lmacross" />
