<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cylin2.aspx.cs" Inherits="Cylin2" %>
...
<table style="width: 100%; height: 131px;" >
    <tr>
        <td class="style6">
             <img src="Images/Header.jpg" width="112%" height="131"  alt="header"/>
        </td>
    </tr>
</table>
<body>
...
mso-bidi-font-family:Wingdings"><span style="mso-list:Ignore; color: #FFFFFF;">§<span style="font:7.0pt &quot;Times New Roman&quot;"> </span></td>
                                           ...
                                           <table style="width: 100%; height: 25px;">
                                                <tr>
                                                    <td style="border-style: 1; border-color: #003399; background-color: #FFFFFF"
                                                        ...
                                                        <strong style="font-size: large; color:Black; font-family: 'Century Gothic'">Sent Cylinder</strong></td>
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.view', function () {
            ...
            $.ajax({
                type: "POST",
                url: "Cylin2.aspx/UpdateCustomer",
                data: '{empid: ' + id + '}',
                                       ...
                                       <asp:ListItem Text="25" Value="25" />
                                        ...
                                        <asp:ListItem Text="100" Value="100" />
                                            ...
                                            <asp:GridView ID="gvDetails" runat="server" AutoGenerateColumns="False"
                                                ...
                                                Width="100%" Style="margin-bottom: 0px" CssClass="grid" BorderWidth="1px"  OnRowDataBound="OnRowCreated">
                                                <Columns>
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
