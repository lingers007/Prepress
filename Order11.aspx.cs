...
public partial class Order11 : System.Web.UI.Page
{
    SqlCommand cmd = new SqlCommand();
    SqlCommand cmd11 = new SqlCommand();
    SqlCommand cmd111 = new SqlCommand();
    SqlCommand cmd1111 = new SqlCommand();
    SqlDataReader dr11, dr111, dr1111;
...
//using (SqlCommand cmd = new SqlCommand("SELECT id,pid,posino FROM job_cylinder ORDER BY CAST(REPLACE(LEFT(posino,CHARINDEX('-',posino)),'-','') AS INT),CAST(LEFT(RIGHT(posino,LEN(posino)-CHARINDEX('-',posino)), PATINDEX('%[^0-9]%', RIGHT(posino,LEN(posino)-CHARINDEX('-',posino))+'.') - 1)  AS INT),RIGHT(posino,LEN(posino)-CHARINDEX('-',posino))", con))
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            con44.Open();
            cm44.CommandType = CommandType.Text;
            cm44.CommandText = "SELECT id FROM job_cylinder WHERE  posino='" + TextBox27.Text + "' ";
            ...
            dbConn333.ConnectionString =  "data source= Technot; Initial Catalog=kaging;User ID=sa;password=Cylindervalve?%*;Integrated Security=False;Max Pool Size=200;";
        ...
        else
        {
            ...
            cm441.CommandText = "SELECT id FROM job_cylinder WHERE  posino='" + TextBox46.Text + "' ";
        ...
        else
        {
            ...
            con441.Open();
            cm441.CommandType = CommandType.Text;
            cm441.CommandText = "SELECT id FROM job_cylinder WHERE  posino='" + TextBox49.Text + "' ";
        ...
        else
        {
            ...
            con441.Open();
            cm441.CommandType = CommandType.Text;
            cm441.CommandText = "SELECT id FROM job_cylinder WHERE  posino='" + TextBox52.Text + "' ";
        ...
        else
        {
            ...
            con441.Open();
            cm441.CommandType = CommandType.Text;
            cm441.CommandText = "SELECT id FROM job_cylinder WHERE  posino='" + TextBox55.Text + "' ";
        ...
        else
        {
            ...
            con441.Open();
            cm441.CommandType = CommandType.Text;
            cm441.CommandText = "SELECT id FROM job_cylinder WHERE  posino='" + TextBox58.Text + "' ";
        ...
        else
        {
            ...
            con441.Open();
            cm441.CommandType = CommandType.Text;
            cm441.CommandText = "SELECT id FROM job_cylinder WHERE  posino='" + TextBox61.Text + "' ";
        ...
        else
        {
            ...
            con441.Open();
            cm441.CommandType = CommandType.Text;
            cm441.CommandText = "SELECT id FROM job_cylinder WHERE  posino='" + TextBox64.Text + "' ";
        ...
        else
        {
            ...
            con441.Open();
            cm441.CommandType = CommandType.Text;
            cm441.CommandText = "SELECT id FROM job_cylinder WHERE  posino='" + TextBox67.Text + "' ";
