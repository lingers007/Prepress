...
<%@ Page Language="C#" AutoEventWireup="true"    Debug="true" CodeFile="JobsV.aspx.cs" Inherits="JobsV" %>
...
<table style="width: 100%; height: 131px;" >
    <tr>
        <td class="style6">
             <img src="Images/Header.jpg" width="111%" height="131"  alt="header"/>
        </td>
    </tr>
</table>
<body>
                        ...
                        <tr>
                            <td align="center" class="style20" 
                                ...
                                <table style="width: 50%; height: 47px;" align="right">
                                    <tr>
                                        <td class="style24" align="right">
                                           <asp:LinkButton ID="LinkButton1" runat="server" ForeColor="Black" PostBackUrl="Home.aspx">Home</asp:LinkButton> |<asp:LinkButton ID="LinkButton2" runat="server"  ForeColor="Black"
                                ...
                                <table id="customGrid" class="display" style="width: 100%; height: 164px; color: #000080; background-color: #000099;">
                                    ...
                                    <tr>
                                        <td class="style102" align="right" bgcolor="White">
                                            <br />
                                            <br />
                                       ...
                                       <asp:ListItem Text="25" Value="25" />
                                        ...
                                        <asp:ListItem Text="50" Value="50" />
                                                    ...
                                                    <asp:GridView ID="gvDetails" runat="server" AutoGenerateColumns="False"
                                                       ...
                                                       <asp:Button  CssClass="view" Text="View" ID="lnkView" runat="server" OnClick="Inkview_Click"     ForeColor="white"   BackColor="orange"  Style="border-radius: 6px"           />
                                                                </ItemTemplate>
                                                                 
                                                            </asp:TemplateField>
                                                             <asp:TemplateField>
                                                                <ItemTemplate>
                                                              <asp:Button  CssClass="view" Text="Edit" ID="lnkView1" runat="server" OnClick="Inkview_Click1"     ForeColor="white"   BackColor="orange"  Style="border-radius: 6px"      />
                                                         </ItemTemplate>
                                                            </asp:TemplateField>
                                                ...
                                                <td>
                                                   ...
                                                   <table style="width:100%; font-size: x-small; font-family: Candara; font-weight:bolder;" class="roundedCorners" align="center">
                                                        ...
                                                        <caption>
                                                            ...
                                                            <asp:Label ID="Labeldie" runat="server" Visible="false"></asp:Label>
                                                                <asp:Label ID="Labeldie1" runat="server" Visible="false"></asp:Label>
